...
$logpath = "actchk.log" 
## report addresses 
$comide = [[ "miyazawa@ray.co.jp", "iwatani@ray.co.jp" ], ["y-kaneda@ray.co.jp", "s-yoshikai@ray.co.jp"] ]
...
unless $debugdebug then 
  $adminary = [ "d-furuya@ray.co.jp","ict@ray.co.jp" ]
else 
...
#  $webmail = "https://www16276.sakura.ne.jp"
  $webmail = "https://sk1.ray.co.jp"
#  $webmailm = "https://www16276.sakura.ne.jp"
  $webmailm = "https://sk1.ray.co.jp"
  $webmailsp = "" 
...
#  puts system($cmd) 
  ...
  #  body.push( '-' * 40) 
    ...
    if $resend then 
      ...
      body.push( 'ITシステムサポートはこちら：https://it.ray.co.jp/html/' )
      $subj = "#{$sl}設定情報"
